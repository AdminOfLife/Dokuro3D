...
void CameraDemo2::Init(dkr::GraphicsMemory* _memory, dkr::Transformer* _transformer, dkr::IRenderTarget* _renderer) {
...
void CameraDemo2::Unload(dkr::GraphicsMemory* _memory, dkr::Transformer* _transformer, dkr::IRenderTarget* _renderer) {
...
void CameraDemo2::Update(float time, dkr::GraphicsMemory* _memory, dkr::Transformer* _transformer, dkr::IRenderTarget* _renderer) {
	rotation += time;
	camera.SetPosition(cosf(rotation) * 4.0f, sinf(rotation) * 4.0f, 0);
	camera.SetRotation(0, rotation, 0);
}
void CameraDemo2::Draw(HWND hWnd, dkr::GraphicsMemory* _memory, dkr::Transformer* _transformer, dkr::IRenderTarget* _renderer) {
